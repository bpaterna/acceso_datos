...
- `id_planta` es la clave primaria en la tabla `plantas` por comodidad se ha declarado autonumérico.
- `id_jardin` es la clave primaria en la tabla `jardines` por comodidad se ha declarado autonumérico.
...
!!! warning "Práctica 2: amplía tu proyecto"
    ...
    **Realiza los siguientes pasos:**
    ...
    1. Crea un menú con las opciones siguientes:
    ...
    2. Añade a tu proyecto un objeto de acceso a datos (DAO) con todas las funciones necesarias para manejar la importación de datos y las operaciones CRUD de la tabla de tu BD y realiza las llamadas correctas a cada función desde cada opción del menú.
    ...
    **Requisitos de funcionamiento:**
    ...
    - Opción **IMPORTAR**: Vacía la tabla de la BD e importa los datos desde el fichero CSV.
    - Opción **LEER**: Muestra por consola la información de la tabla.
    - Opción **AÑADIR**: Pide todos los campos menos el id (que es autonumérico). Los campos numéricos se pedirán hasta que sean válidos, es decir, ser número y ser del tipo correcto.
    ...
    **Aspectos técnicos:** mismos que en la práctica anterior. Además:

    - El menú solamente contiene las llamadas a las funciones. Toda la lógica de cada operación debe implementarse en funciones separadas.
...
!!! warning "Práctica 3: finaliza tu aplicación"
    ...
    **Requisitos de funcionamiento:** mismos que en la práctica anterior. Además:
    ...
    - TRANSACCIONES: Pedir por teclado los id de las dos tablas relacionadas y el otro campo (equivalente a la cantidada del ejemplo de plantas). Comprobar que los dos id existen en las respectivas tablas antes de hacer el insert en la tercera tabla.
