...
```sql
INSERT INTO plantas (nombre_comun, nombre_cientifico, stock, precio)
VALUES ('Aloe Vera', 'Aloe barbadensis miller', 7,2.5);
```

```sql
INSERT INTO plantas (nombre_comun, nombre_cientifico, stock, precio)
VALUES ('Lavanda', 'Lavandula angustifolia',3,1.8);
```
